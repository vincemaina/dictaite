            ...
            <div>
                <div className="flex gap-5 justify-between items-start">
                    <div className="flex flex-col gap-3">
                        <h2 className="text-3xl text-sky-200 font-medium">Testing Voice Transcription with Pookie</h2>
            ...
            <div className="flex gap-16 mt-12">
                ...
                <div className="w-full max-w-sm bg-neutral-800 p-7 rounded-xl text-sm">
                    ...
                    <ul className="list-outside ml-4 list-disc space-y-4 font-light text-neutral-400">
                        <li className="list-item">Testing a new and improved <span className="text-sky-200">dictation</span> app.</li>
                        ...
                        <li className="list-item">The app <span className="text-sky-200">uses AI</span> to transcribe the voice notes.</li>
